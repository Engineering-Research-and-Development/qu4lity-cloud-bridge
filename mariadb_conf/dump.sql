...
CREATE TABLE IF NOT EXISTS MeasureResult
( measureResult_id INT NOT NULL AUTO_INCREMENT,
  measure_id INT NOT NULL,
  failureType_id INT,
  ...
  recoveryTime INT,
  description TEXT(64),
  PRIMARY KEY (measureResult_id),
  CONSTRAINT measureResult_fk_1 FOREIGN KEY (measure_id) REFERENCES Measure(measure_id) ON DELETE CASCADE,
  CONSTRAINT measureResult_fk_2 FOREIGN KEY (failureType_id) REFERENCES FailureType(failureType_id) ON DELETE CASCADE,
  CONSTRAINT measureResult_fk_3 FOREIGN KEY (product_id) REFERENCES Product(product_id) ON DELETE CASCADE
);
...
( operation_id INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT operation_fk_1 FOREIGN KEY (operationType_id) REFERENCES OperationType(operationType_id) ON DELETE CASCADE,
  CONSTRAINT operation_fk_2 FOREIGN KEY (materialUsedAsCarrier_id) REFERENCES Material(material_id) ON DELETE CASCADE,
  CONSTRAINT operation_fk_3 FOREIGN KEY (materialUsedAsTarget_id) REFERENCES Material(material_id) ON DELETE CASCADE,
  CONSTRAINT operation_fk_4 FOREIGN KEY (materialTransformation_id) REFERENCES Material(material_id) ON DELETE CASCADE,
  CONSTRAINT operation_fk_5 FOREIGN KEY (resource_id) REFERENCES Resource(resource_id) ON DELETE CASCADE
);
...
( function_id INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT function_fk_1 FOREIGN KEY (resource_id) REFERENCES Resource(resource_id) ON DELETE CASCADE,
  CONSTRAINT function_fk_2 FOREIGN KEY (materialUsedAsCarrier_id) REFERENCES Material(material_id) ON DELETE CASCADE,
  CONSTRAINT function_fk_3 FOREIGN KEY (materialUsedAsTarget_id) REFERENCES Material(material_id) ON DELETE CASCADE
);
